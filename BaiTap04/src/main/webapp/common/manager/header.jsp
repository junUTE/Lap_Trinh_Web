...
<nav class="navbar navbar-expand-lg navbar-dark glassmorphism">
	<div class="container">
		<a class="navbar-brand" href="${pageContext.request.contextPath}/home">
			<i class="fas fa-store me-2"></i> WEB của Jun
		</a>
		...
		<div class="collapse navbar-collapse" id="mainNav">
			<ul class="navbar-nav me-auto">
				...
				<li class="nav-item"><a
					class="nav-link <c:if test='${fn:contains(pageContext.request.servletPath, "/home")}'>active</c:if>'"
					href="${pageContext.request.contextPath}/home"> <i
						class="fas fa-home me-1"></i> Trang Chủ
				</a></li>

				<li class="nav-item"><a
					class="nav-link <c:if test='${fn:contains(pageContext.request.servletPath, "/products")}'>active</c:if>'"
					href="${pageContext.request.contextPath}/products"> <i
						class="fas fa-box me-1"></i> Sản Phẩm
				</a></li>

				<li class="nav-item"><a
					class="nav-link <c:if test='${fn:contains(pageContext.request.servletPath, "/contact")}'>active</c:if>'"
					href="${pageContext.request.contextPath}/contact"> <i
						class="fas fa-envelope me-1"></i> Liên Hệ
				</a></li>
					...
					<ul class="dropdown-menu dropdown-menu-end shadow"
						...
						<li><a class="dropdown-item"
							href="${pageContext.request.contextPath}/profile"> <i
								class="fas fa-user-cog me-2"></i> Chỉnh sửa thông tin
						</a></li>
						...
						<c:if test="${sessionScope.account.role == 1}">
							<li><a class="dropdown-item"
								href="${pageContext.request.contextPath}/admin/home"> <i
									class="fas fa-cogs me-2"></i> Trang quản trị
							</a></li>
						</c:if>
