		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 additional-nav">
				<ul class="list-unstyled list-inline pull-right">
					<li><a href="${pageContext.request.contextPath}/profile">Edit
							Profile</a></li>
					...
					<li><select class="form-select"
						onchange="if(this.value) window.location.href=this.value;">
							...
							<option
								value="${pageContext.request.contextPath}/admin/category/add">Add
								Category</option>
							<option
								value="${pageContext.request.contextPath}/admin/categories">List
								Categories</option>
					</select></li>
			...
			<ul>
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						<li class="dropdown-submenu"><a href="#">Hi Tops <i
				...
				<li><a href="admin/home" target="_blank">Admin theme</a></li>
