...
public class CategoryController {
	...
	@ResponseBody
	public ResponseEntity<Category> addCategory(@RequestParam("categoryName") String categoryName,
		...
		try {
			...
			if (icon != null && !icon.isEmpty()) {
				...
				storageService.store(icon, storeFilename); // lưu file
				c.setImages(storeFilename); // lưu tên file vào DB
			}
