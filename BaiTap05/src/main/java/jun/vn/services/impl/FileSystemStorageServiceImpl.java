...
import jun.vn.Exception.StorageException;
...
public class FileSystemStorageServiceImpl implements IStorageService {
	...
	public void store(MultipartFile file, String storeFilename) {
		try {
			...
			Path destinationFile = this.rootLocation.resolve(Paths.get(storeFilename)).normalize().toAbsolutePath(); // lấy đường dẫn tuyệtđối
